# OPUS · brand and system

These documents are the operating reference for OPUS as a brand, a product line,
and a small creative business run by mostly one person. They were written after
reading every property that exists today: this repository (opus.ro), the Loop
app and its site (opusloop.co), the Chéri specs, the eratic.ro setup, and the
older notes in `_inspiration/`.

They are written to be kept, not read once. When something here stops being
true, change the document in the same commit as the change that made it false.

| Document | What it settles |
|---|---|
| [01 · Story](01-story.md) | Why OPUS exists, in the words the website will use. The one thesis everything hangs from. |
| [02 · Brand](02-brand.md) | Name, descriptor, voice, vocabulary law, visual system. What OPUS is not. |
...
- **Before writing anything public** (a page, an App Store description, a
  post, a release note): reread 02 · Brand §Voice and §Vocabulary law.
- **Before adding a tool to the website:** 03 · Products §Status and §Page
  template. A tool gets a page when it has something real to show, not before.
- **Before adding a channel, platform or service:** 04 · System §Principles.
  If it cannot be dropped later without breaking anything, do not add it.
